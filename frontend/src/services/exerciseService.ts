...
export const FALLBACK_EXERCISES: Exercise[] = [
  ...
  // 18. TRAPS (Catalog)
  {
    ...
    secondary_muscles: 'Forearm Grip',
    description: 'Scapular elevation movement for upper back and neck resilience.',
    instructions: '1. Hold dumbbells at sides with neutral grip.\n2. Elevate shoulders straight up toward ears.\n3. Pause for 1 second at top contraction.\n4. Lower weights with smooth 2-second control.',
    common_mistakes: 'Rolling shoulders in circles, using excessive momentum from knees.',
    difficulty: 'Beginner',
    equipment: 'Dumbbells',
    default_camera_angle: 'Front View',
    camera_setup_instructions: 'Position camera in front showing shoulders.',
    ideal_rom_degrees: 30,
    normative_cadence_seconds: 2.5,
    analysis_supported: false,
  },
  // 19. NECK (Catalog)
  {
    ...
    secondary_muscles: 'Cervical Stabilizers',
    description: 'Concussion prevention and posture stabilization drill for young athletes.',
    instructions: '1. Place palm against forehead or temple.\n2. Apply moderate isometric resistance while keeping head neutral.\n3. Hold for 5-10 seconds per vector.\n4. Repeat for flexion, extension, and lateral flexion.',
    common_mistakes: 'Jerking or forceful hyperflexion of cervical spine.',
    difficulty: 'Beginner',
    equipment: 'Bodyweight',
    default_camera_angle: 'Front/Side View',
    camera_setup_instructions: 'Position camera at head level.',
    ideal_rom_degrees: 0,
    normative_cadence_seconds: 10.0,
    analysis_supported: false,
  },
  // 20. ADDUCTORS (Catalog)
  {
    id: 24,
    category_id: 14,
    category_name: 'Adductors',
    name: 'Copenhagen Side Plank',
    slug: 'copenhagen_plank',
    target_muscles: 'Adductor Longus, Adductor Magnus, Obliques',
    secondary_muscles: 'Core Stabilizers, Gluteus Medius',
    description: 'High-yield groin injury prevention and groin strength benchmark.',
    instructions: '1. Rest top foot on bench in a side plank posture.\n2. Raise bottom leg to touch underside of bench.\n3. Maintain rigid hip alignment without sagging toward floor.\n4. Hold for prescribed duration.',
    common_mistakes: 'Letting pelvis rotate forward or sag downward.',
    difficulty: 'Intermediate',
    equipment: 'Bench',
    default_camera_angle: 'Side View',
    camera_setup_instructions: 'Position camera side-on showing full plank alignment.',
    ideal_rom_degrees: 180,
    normative_cadence_seconds: 20.0,
    analysis_supported: false,
  }
];
