...
import {
  TrendingUp, Activity, Moon, Utensils, Award,
  ChevronRight, ArrowUpRight, Flame, Loader2, CheckCircle2
} from "lucide-react";
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className={`text-[11px] font-semibold px-2 py-0.5 rounded-full border ${
                  ...
                  {sess.overall_score >= 85 ? t("progress.solidForm", "Solid Form") : t("progress.needsWork", "Needs Work")}
                </span>
