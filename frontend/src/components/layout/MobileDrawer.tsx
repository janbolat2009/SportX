...
import {
  ...
  Bot, User as UserIcon, Settings, LogIn, UserPlus, LogOut, Globe, Check
} from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 md:hidden flex justify-end">
      ...
      <div
        ...
        className="relative w-[85vw] max-w-[320px] h-full bg-zinc-950 border-l border-zinc-800 shadow-2xl flex flex-col justify-between overflow-y-auto p-4 sm:p-5 z-10 animate-in slide-in-from-right duration-200"
      >
        {/* Top Header inside Drawer */}
        <div className="space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-zinc-850">
            <div onClick={() => handleNavClick('train')} className="cursor-pointer">
              <Logo size="sm" />
            </div>
            <button
              onClick={onClose}
          ...
          {isAuthenticated && user && (
            <div
              ...
              className="p-3 rounded-2xl bg-zinc-900/80 border border-zinc-800 flex items-center gap-3 cursor-pointer hover:border-zinc-700 transition-colors"
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[10px] text-zinc-400 font-mono capitalize">{user.role || 'Athlete'}</p>
              </div>
            </div>
          )}
          ...
          <nav className="space-y-1 py-1">
            ...
            <button
              ...
              className={`w-full min-h-[48px] px-3.5 rounded-xl flex items-center gap-3 text-xs font-bold transition-all ${
                currentTab === 'train'
            ...
            {isAuthenticated ? (
              <>
                ...
                >
                  <Activity className="w-4 h-4 shrink-0 text-brand-400" />
                ...
                >
                  <TrendingUp className="w-4 h-4 shrink-0 text-brand-400" />
